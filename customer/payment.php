...
<div style="margin:-10px 10px 20px 430px;">
    Payment options:    
...
<div style="margin-left: 380px;" class="col-md-3">
                                                        ...
                                                        <div class="first-row form-group">
                                                            ...
                                                            <div class="paymntf_card_number_grids">
                                                             ...
                                                             -->
                                                                ...
                                                                <select class="number credit-card-number form-control" style="background-color:#BED0E9; width:200px;">
                                                                ...
                                                                <select class="number credit-card-number form-control" style="background-color:#BED0E9; margin: -38px 0px 0px 200px; width: 155px;">                                                                   
    ...
    if(isset($_REQUEST['btnSubmit']))
    {
              ...
              $otp= rand(1111,9999);
            echo '<script>location.href="otp.php?otp='.$otp.'"</script>';
