...
<div style="margin-top: 50px; margin-left: 150px; ">
    ...
    <table class="d"  style="margin:50px; max-width: 550px;">
            
            <?php
                        $q="select tblproduct.*,tblorderchild.*,tblordermaster.* from tblproduct,tblorderchild,tblordermaster where tblproduct.pId=tblorderchild.pId and tblordermaster.oid=tblorderchild.oid and tblordermaster.oid ='$id'";
//                        echo $q;
                        $s= mysqli_query($conn, $q);
                        while($r= mysqli_fetch_array($s))
                        {
                            ...
                            echo '<tr><td>TOTAL :'.$r['oTotal'].'</td></tr>';
