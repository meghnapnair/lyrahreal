...
<div style="margin:70px 100px 50px 70px; border-style: solid; width: 240px; padding: 10px; border-width: thin; border-radius: 5px; border-color: #C1C1C1;">
    <form method="POST">
        <h5 style="margin:10px; ">Search</h5>
    <div>
        <input type="text"style="width: 180px;" class="form-control" >
        <a href="search.php"><img src="../images/search.jpg" style="margin:-40px 5px 5px 180px; width: 40px; height: 40px;"></a>
    </div>
    ...
    <table  style="margin:50px; ">
            ...
            <?php
                        ...
                        while($r= mysqli_fetch_array($s))
                        {
                            ...
                            echo '<br/><br/><a href="productdetails.php?id='.$r[0].'">View more...</a></td>';
                  echo '</tr>';
