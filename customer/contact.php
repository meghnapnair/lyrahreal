    ...
    <section class="wthree-row pt-3 pb-sm-5 w3-contact">
        <div class="container py-sm-5 pb-5">
            ...
            <div class="row contact-form pt-lg-5">
                ...
                <!-- contact details -->
                <div style="margin-left: -350px;" class="col-lg-6 contact-bottom pl-5 mt-lg-0 mt-5">
                    <!-- contact details grid1-->
                    <div class="address">
                        <h5 class="pb-3 text-capitalize">Address</h5>
                        <address>
                            <p class="c-txt">House no:10,Madakkathanam p.o.</p>
                            <p class="c-txt">Muvattupuzha.pin code:686670.</p>
                        </address>
                    </div>
            ...
            <div class="container-fluid py-5 footer-copy_w3ls">
                <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="cpy-right align-self-center">
                        ...
                        <p>© 2020 LYRAH store. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
